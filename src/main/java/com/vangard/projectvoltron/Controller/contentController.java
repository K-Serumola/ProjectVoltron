...
public class contentController {
    ...
    @GetMapping("/money-match")
    public String moneymatch(){
        return "money-match";
    }
 
    @GetMapping("/scam-or-legit")
        public String scammorlegit(){
        return "scam-spotter";
    }
 
    @GetMapping("/budget-buddy")
    public String bb(){
        return "budget-buddy";
    }

    @GetMapping("/spend smart")
    public String spendSmart(){
        return "spend-smart";
    }
}